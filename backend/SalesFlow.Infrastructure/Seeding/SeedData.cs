...
/// <summary>
/// Seed data for testing: 20 products + 5 clients
/// Call from Program.cs using dependency injection
/// </summary>
public static class SeedDataFixed
{
    ...
    /// <summary>
    /// Seed 20 test products into database
    /// Usage in Program.cs:
    ...
    /// <summary>
    /// Seed 5 test clients into database
    /// Usage in Program.cs:
    /// using var scope = app.Services.CreateScope();
    /// var dbContext = scope.ServiceProvider.GetRequiredService<AppDbContext>();
